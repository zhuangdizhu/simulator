...
class FpgaScheduler(object):
    ...
    def execute_scheduling(self, job_id, event_type):
        ...
        elif self.scheduling_algorithm == "FIFO" or "SJF":
...
if __name__ == "__main__":
    if len(sys.argv) != 7:
        print "Usage: ", sys.argv[0], "<port> <algorithm> <mode> <fpga_info_file> <E/2,1> <K/5,6,7,>"
        print "Example: ./scheduler 9000 FIFO Local fpga_node.txt 1 5 "
        print "Example: ./scheduler 9000 FIFO TCP /home/zdzhu/fpga_node.txt 2 6"
        print "Example: ./scheduler 9000 FIFO RDMA /home/zdzhu/fpga_node.txt 3 6"
    else:
        algorithm=""
        mode = ""
        if sys.argv[2] == "FIFO" or sys.argv[2] == "Local" or sys.argv[2] == "Queue" or sys.argv[2] == "SJF":
            algorithm = sys.argv[2]
            print "Using algorithm %r ...." %algorithm
        else:
            print "Wrong Scheduler name. Scheduler should be Local, FIFO, SJF or Queue."
            exit(0)
