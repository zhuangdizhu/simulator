    ...
    def generate_job(self, job_num):
        ...
        if self.pattern == "Tiny":
            ...
            for i in job_list:
                ...
                arrival_time = (in_buf_size/throughput)*scale
                arrival_time = int(arrival_time)
                arrival_time = int(scale * np.abs(np.random.normal(self.mu, self.sigma))*s_size/2/throughput)
                job_param[i] = (acc_name, in_buf_size, arrival_time)
            ...
            for i in job_list:
                ...
                arrival_time = (in_buf_size/throughput)*scale
                arrival_time = int(arrival_time)
                arrival_time = int(scale * np.abs(np.random.normal(self.mu, self.sigma))*m_size/2/throughput)
                job_param[i] = (acc_name, in_buf_size, arrival_time)
            ...
            for i in job_list:
                ...
                arrival_time = (in_buf_size/throughput)*scale
                arrival_time = int(arrival_time)
                arrival_time = int(scale * np.abs(np.random.normal(self.mu, self.sigma))*xl_size/throughput)
                job_param[i] = (acc_name, in_buf_size, arrival_time)
            ...
            for i in ss_list:
                ...
                in_buf_size = int(np.abs(np.random.normal(self.mu, self.sigma))*ss_size+1)
                in_buf_size = random.randint(default_size, ss_size)
                arrival_time = int(scale * np.abs(np.random.normal(self.mu, self.sigma))*ss_size/throughput+1)
                job_param[i] = (acc_name, in_buf_size, arrival_time)
            ...
            for i in s_list:
                ...
                in_buf_size = int(np.abs(np.random.normal(self.mu, self.sigma))*s_size+1)
                in_buf_size = random.randint(ss_size, s_size)
                arrival_time = int(scale * np.abs(np.random.normal(self.mu, self.sigma))*s_size/2/throughput+1)
                job_param[i] = (acc_name, in_buf_size, arrival_time)
            ...
            for i in m_list:
                ...
                in_buf_size = int(np.abs(np.random.normal(self.mu, self.sigma))*m_size+1)
                in_buf_size = random.randint(s_size+1, m_size)
                arrival_time = int(scale * np.abs(np.random.normal(self.mu, self.sigma))*m_size/2/throughput+1)
                job_param[i] = (acc_name, in_buf_size, arrival_time)
